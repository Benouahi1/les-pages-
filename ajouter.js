...
document.getElementById("AJOUTER").onclick = function(){
   ...
   ajouteNom.type = "text";
    ...
    let maladie = document.createElement("p");
    maladie.innerHTML = "Maladie";
    let ajoutemaladie = document.createElement("input");
    ajoutemaladie.type = "text";
    ajoutemaladie.placeholder = "Maladie";
    document.getElementById("list-ajouter").appendChild(maladie);
    document.getElementById("list-ajouter").appendChild(ajoutemaladie).value;
    ...
    button.onclick = function(){
        ...
        document.getElementById("maladie 1").innerHTML = ajoutemaladie.value;
